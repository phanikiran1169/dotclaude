---
name: no-ai-slop
description: Edits prose into sharper, more human writing while keeping the writer's voice, or flags
  AI-slop patterns without rewriting. Use for a README, docs, a design note, a report, a post, or any
  draft the user wants clearer, more direct, more opinionated, or less AI-sounding, and when asked
  whether writing reads as AI. For comments and docstrings inside source files, use code-comments.
---
...
- **Keep it readable without losing the substance.** Keep the nuance and the precision. Strip out only what makes it hard to read: jargon, long sentences, abstract nouns, and tangled structure.
...
- **Be concrete and specific.** A vague sentence gives the reader nothing to hold on to. "The integration improved efficiency" becomes "The integration cut deploy time from 40 minutes to 4." Names, numbers, dates, mechanisms, and examples beat abstractions.
...
- **Let the facts carry the point.** Make actions, examples, and consequences do the work. Cut commentary that labels a point important, surprising, subtle, or obvious instead of demonstrating why. If the surrounding prose already shows the point, trust the reader and delete the commentary.
...
**Telling the reader what to notice.** Cut lines that step outside the subject to say how much weight to give something, or how to read it: "That last part matters more than it sounds," "The key point is," "As you can see," "This distinction matters," and redundant "In other words." If the point is clear, delete the aside. Otherwise, replace it with support or facts already in the content.
